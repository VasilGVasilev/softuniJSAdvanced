...
const detailsTemplate = (furniture) => html`
        ...
        <div class="row space-top">
            ...
            <div class="col-md-4">
                ...
                <p>Year: <span>${furniture.yeat}</span></p>
                ...
                <div>
                    ...
                    <a href=”/delete” id=${furniture._id} class="btn btn-red" style="display: ${furniture._ownerId == localStorage.ownerId ? 'inline': 'none'}">Delete</a>
                </div>
            </div>
        </div>
`
